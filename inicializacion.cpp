//
// Created by Alan Corona on 12/1/2022.
//
//
...
__attribute__((unused)) ShoppingCart llenarCarrito(Product cat[], int cantProductos){
    int respuesta = 1;
    int numeroProducto;
    int cantidad;
    ShoppingCart nuevo;
...
void ProcesoCompra(Product prod[]){
    ...
    char respuesta = 's';
    while (respuesta == 's' && miCarrito.getAmountProduct() <= 20){
        cout << "Numero de producto a comprar: ";
        cin >> numProducto;
        cout << "Cantidad: ";
    ...
    while (option != 7){
        ...
        switch (option){
            ...
            case 6:
                ...
                break;
            case 7:
                cout << "Adios " << users[id-1].getName() << endl;
